...
public class SphereWorld3 implements CommonRenderer {
	...
	public SphereWorld3(Context ctx) {
	...
	public void init(GL10 gl, EGLConfig config) {
	    ...
	    gl.glClearStencil(0);
	    gl.glStencilFunc(GL10.GL_EQUAL, 0x0, 0x01);
	    
	    // Setup Fog parameters
	    gl.glEnable(GL10.GL_FOG);
	    gl.glFogfv(GL10.GL_FOG_COLOR, fLowLight, 0);
	    gl.glFogf(GL10.GL_FOG_MODE, GL10.GL_LINEAR);
	    gl.glFogf(GL10.GL_FOG_START, 5.0f);
	    gl.glFogf(GL10.GL_FOG_END, 30.0f);
	...
	private void DrawGround(GL10 gl) {
		 float fExtent = 20.0f;
		    ...
		    ByteBuffer bb = ByteBuffer.allocateDirect(40 * 2 * 3 * 4);
		    bb.order(ByteOrder.nativeOrder());
		    FloatBuffer vertex = bb.asFloatBuffer();
		    vertex.position(0);
		    
		    bb = ByteBuffer.allocateDirect(40 * 3 * 4);
		    bb.order(ByteOrder.nativeOrder());
		    ...
		    for(iStrip = -fExtent; iStrip <= fExtent; iStrip += fStep)
		        {
		            ...
		            gl.glDrawArrays(GL10.GL_TRIANGLE_STRIP, 0, 80);
		        }
